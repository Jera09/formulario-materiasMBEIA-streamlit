...
def MEDE():
    ...
    areas_competencias = {
        "**Dirección y Liderazgo(Debes seleccionar una materia o del área de Planeación y Estratégia)": [
        ...
        "**Planeación y Estratégia (Debes seleccionar una materia o del área de Dirección y Liderazgo)": [
        ...
        "**Innovación Tecnológica y Emprendimiento (Selecciona al menos 1 materia":[
    ...
    with st.form("registro_form"):
        ...
        st.write("## Programa: Estratégia y dirección de empresas")
        st.write("")
        st.write("## Consideraciones para el llenado del formulario:")
        st.write(""" 
        ##### - ***Debes seleccionar al menos 1 materia*** del área de Dirección y Liderazgo o de Planeación y Estrategia
        ##### - ***Debes seleccionar al menos 1 materia*** del área de Innovación Tecnológica y Emprendimiento
        ...
        if submitted:
            ...
            if not all([nombre, telefono, correo]):
                ...
                materias_direccion_o_planeacion = [
                    "Negociación estratégica*", "Competencias de liderazgo para la gestión de equipos de alto desempeño",
                    "Gestión de empresas familiares y PYMES", "Marco global de la dirección", "Cultura de calidad empresarial",
                    "Simulación de negocios", "Tópicos selectos de estrategia y dirección", "Visión estratégica de la tecnología"
                ]
                seleccionadas_direccion_o_planeacion = [m for m in materias_con_obligatorias if m in materias_direccion_o_planeacion]
                # Validar materias de Innovación Tecnológica y Emprendimiento
                materias_Innovacion = [
                    "Administración de proyectos*", "Desing Thinking*",
                    "Emprendimiento de negocios", "Mindset digital", 
                ]
                seleccionadas_innovacion = [m for m in materias_con_obligatorias if m in materias_Innovacion]
                
                if len(seleccionadas_direccion_o_planeacion) < 1:
                    st.error("Debes seleccionar al menos  materia del área 'Dirección y Liderazgo' o 'Planeación y Estratégia'.")
                elif len(seleccionadas_innovacion) < 1:
                    st.error("Debes seleccionar al menos  materia del área 'Innovación Tecnológica y Emprendimiento'.")
                else:
                    ...
                    if total_materias > 13:
                        ...
                        programa = "Estratégia y Dirección de Empresas"
