...
def MDEIS():
    ...
    areas_competencias = {
        ...
        "**Fundamentos y Hospitalidad en la Salud (Seleccionar al menos 2 materias)":[
            {"materia": "Administración de centros de investigación Intrahospitalarios", "curso": "SLD", "clave": "55700", "créditos": 6},
            {"materia": "Calidad en los servicios de salud", "curso": "SLD", "clave": "55702", "créditos": 6},
    ...
    materias_obligatorias = [
        ...
        {"materia": "Bioética", "curso": "SLD", "clave": "55701", "créditos": 7},
        {"materia": "Internalización y Sustentabilidad de las Organizaciones de la Salud", "curso": "SLD", "clave": "55704", "créditos": 7},
    ]
    ...
    with st.form("registro_form"):
        ...
        st.write("## Programa: Dirección Estratégica de Instituciones de Salud")
        st.write("")
        st.write("## Consideraciones para el llenado del formulario:")
        st.write(""" 
        ##### - ***Debes seleccionar al menos 2 materias*** del área de Fundamentos y Hospitalidad en la Salud
        ##### - Recuerda seleccionar un ***máximo*** de 9 materias (58 créditos)
        ##### - Las materias obligatorias (Liderazgo de acción positiva, Planeación Estratégica de las organizaciones, Bioética, Internacionalización y Sustentabilidad de las organizaciones de salud) ya se encuentran ***precargadas*** (27 créditos)
        ...
        if submitted:
            ...
            if not all([nombre, telefono, correo]):
                ...
                materias_salud = [
                    "Administración de centros de investigación Intrahospitalarios", "Calidad en los servicios de salud", "Dirección de los negocios hospitalarios",
                ]
                seleccionadas_salud = [m for m in materias_con_obligatorias if m in materias_salud]
                
                if len(seleccionadas_salud) < 2:
                    st.error("Debes seleccionar al menos 2 materias del área 'Fundamentos y Hospitalidad en la salud'.")
                else:
                    ...
                    if total_materias > 13:
                        ...
                        programa = "Dirección Estratégica de Instituciones de Salud"
