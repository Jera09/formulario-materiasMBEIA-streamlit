...
def MIEDT():
    ...
    with st.form("registro_form"):
        ...
        st.write("## Programa: Innovación, Emprendimiento y Dirección de Tecnología")
        st.write("")
        ...
        #### - Las materias obligatorias (Liderazgo de acción positiva, Planeación Estratégica de las organizaciones, Modelos y Herramientas de Analítica de Datos Aplicada a los Negocios,  Desing Thinking, Mindset digital) ya se encuentran ***precargadas*** (34 créditos)
        ...
        if submitted:
            ...
            if not all([nombre, telefono, correo]):
                ...
                materias_innovacion_emprendimiento = [
                    "Administración de proyectos*", "Emprendimiento de negocios",
                    "Negocios electrónicos"
                ]
                seleccionadas_innovacion_emprendimiento = [m for m in materias_con_obligatorias if m in materias_innovacion_emprendimiento ]
                
                if len(seleccionadas_innovacion_emprendimiento) < 1:
                    ...
                    if total_materias > 13:
                        ...
                        programa = "Innovación, Emprendimiento y Dirección de Tecnología"
