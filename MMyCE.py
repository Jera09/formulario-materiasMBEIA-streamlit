...
def mmyce():
    ...
    areas_competencias = {
        ...
        "**Comunicación (Debes seleccionar una materia o del área de Mercadotecnia)":[
            ...
            {"materia": "Investigación y Evaluación de la Comunicación Estratégica", "curso": "COM", "clave": "55703", "créditos": 6},
        ...
        "**Mercadotecnia (Debes seleccionar una materia o del área de Comunicación)":[
    ...
    with st.form("registro_form"):
        ...
        st.write("## Programa: Mercadotecnia y Comunicación Estratégica")
        st.write("")
        ...
        if submitted:
            ...
            if not all([nombre, telefono, correo]):
                ...
                # Validar materias de Comunicación y/o mercadotecnia
                materias_comunicacion_o_mercadotecnia = [
                    "Comunicación digital*", "Comunicación de crisis",
                    "Investigación y Evaluación de la Comunicación Estratégica", "Planeación de campañas de comunicación", "Responsabilidad social organizacional y comunicación",
                    "Comercio electrónico y estrategias de mercadotecnia digital*", "Innovación y creatividad aplicada a la mercadotecnia y a la comunicación", "Inteligencia y perspectiva estratégica del consumidor"
                    "Mercadotecnia social", "Neuromarketing"
                ]
                seleccionadas_comunicacion_o_mercadotecnia = [m for m in materias_con_obligatorias if m in materias_comunicacion_o_mercadotecnia]
                
                if len(seleccionadas_comunicacion_o_mercadotecnia) < 1:
                    st.error("Debes seleccionar al menos  materia del área 'Comunicación' o 'Mercadotecnia'.")
                else:
                    ...
                    if total_materias > 13:
                        ...
                        programa = "Mercadotecnia y Comunicación Estratégica"
